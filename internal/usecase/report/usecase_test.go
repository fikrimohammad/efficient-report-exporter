...
func newMockRepositories(t *testing.T) (*mock.MockMySQL, *mock.MockMQ, *mock.MockRedis, *mock.MockS3) {
	t.Helper()
	ctrl := gomock.NewController(t)
	return mock.NewMockMySQL(ctrl), mock.NewMockMQ(ctrl), mock.NewMockRedis(ctrl), mock.NewMockS3(ctrl)
}
