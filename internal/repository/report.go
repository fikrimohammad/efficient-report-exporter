...
type ReportMQ interface {
	PublishExportReportProcessMsg(ctx context.Context, params mqmodel.ExportReportProcessMessage) error
	PublishExportReportDoneMsg(ctx context.Context, params mqmodel.ExportReportDoneMessage) error
}
