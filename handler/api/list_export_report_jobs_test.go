...
func TestListExportReportJobs_Success(t *testing.T) {
	mockUC := &mockReportUseCase{
		listExportReportJobs: func(_ context.Context, params usecase.ListExportReportJobsParams) (*usecase.ListExportReportJobsResult, error) {
...
func TestListExportReportJobs_Success_EmptyResult(t *testing.T) {
	mockUC := &mockReportUseCase{
		listExportReportJobs: func(_ context.Context, _ usecase.ListExportReportJobsParams) (*usecase.ListExportReportJobsResult, error) {
			return &usecase.ListExportReportJobsResult{
				Jobs:          []usecase.ExportReportJobSummary{},
				NextPageToken: 0,
			}, nil
